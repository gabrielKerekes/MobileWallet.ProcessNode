 ...
 */
package com.mobilewallet.processnode;
...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            serversURIs[0] = "ssl://147.175.98.16:8883";
            serversURIs[1] = "ssl://test.mosquitto.org:8883";
            if(args.length == 2){
                if (args[1].equals("8883")) {
                    serversURIs[0] = "ssl://" + args[0] + ":" + args[1];
                } else {
